  ...
  return (
    <CardContainer className="text-center">
      ...
      <CardBody className="d-flex flex-column">
        <DetailsLink to={`${book.id}/`}>
          <Card.Title>{book?.shortTitle || book.title}</Card.Title>
        </DetailsLink>
        {book?.link ? (
          <ButtonContainer>
            <CardButton variant="dark" target="_blank" href={book.link}>
              Buy <Cart size={20} />
            </CardButton>
          </ButtonContainer>
        ) : (
          ...
          >
            <ButtonContainer>
              <CardButton variant="dark" disabled>
                Buy <Cart size={20} />
              </CardButton>
            </ButtonContainer>
          </OverlayTrigger>
